...
const PAGES_FR: Record<PageKey, Page> = {
  ...
  obsession: { title: "L'obsession sélective", subtitle: "Le deux poids, deux mesures appliqué aux Juifs, à Israël, et à tout ce qu'on leur associe", category: "reconnaitre", order: 1, path: "/obsession" },
...
const PAGES_EN: Record<PageKey, Page> = {
  ...
  obsession: { title: "Selective obsession", subtitle: "The double standard applied to Jews, Israel, and everything associated with them", category: "reconnaitre", order: 1, path: "/selective-obsession" },
